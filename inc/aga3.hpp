...
public:
    ...
    R norm2() const {
        ...
        auto& x = *this;
        return (pow(x[3], 2) + pow(x[0], 2) + pow(x[1], 2) + pow(x[2], 2));
    }
    ...
    Mv02<R> inv() const {
        ...
        auto& x = *this;
        return Mv02<R>((x[0] * pow((pow(x[3], 2) + pow(x[0], 2) + pow(x[1], 2) + pow(x[2], 2)), -1)), (-1 * x[1] * pow((pow(x[3], 2) + pow(x[0], 2) + pow(x[1], 2) + pow(x[2], 2)), -1)), (-1 * x[2] * pow((pow(x[3], 2) + pow(x[0], 2) + pow(x[1], 2) + pow(x[2], 2)), -1)), (-1 * x[3] * pow((pow(x[3], 2) + pow(x[0], 2) + pow(x[1], 2) + pow(x[2], 2)), -1)));
    }
...
public:
    ...
    Mv13<R> inv() const {
        ...
        auto& x = *this;
        return Mv13<R>((x[0] * pow((pow(x[3], 2) + pow(x[0], 2) + pow(x[1], 2) + pow(x[2], 2)), -1)), (x[1] * pow((pow(x[3], 2) + pow(x[0], 2) + pow(x[1], 2) + pow(x[2], 2)), -1)), (x[2] * pow((pow(x[3], 2) + pow(x[0], 2) + pow(x[1], 2) + pow(x[2], 2)), -1)), (-1 * x[3] * pow((pow(x[3], 2) + pow(x[0], 2) + pow(x[1], 2) + pow(x[2], 2)), -1)));
    }
...
Mv1<R> operator*(R const& x, Mv1<R> const& y) {
    ...
    return Mv1<R>((x * y[0]), (x * y[1]), (x * y[2]));
}

template <class R>
Mv2<R> operator*(R const& x, Mv2<R> const& y) {

    return Mv2<R>((x * y[0]), (x * y[1]), (x * y[2]));
}

template <class R>
Mv02<R> operator*(R const& x, Mv02<R> const& y) {

    return Mv02<R>((x * y), (x * y[1]), (x * y[2]), (x * y[3]));
}

template <class R>
Mv13<R> operator*(R const& x, Mv13<R> const& y) {

    return Mv13<R>((x * y[0]), (x * y[1]), (x * y[2]), (x * y[3]));
}

template <class R>
Mv3<R> operator*(R const& x, Mv3<R> const& y) {
...
Mv1<R> operator*(Mv1<R> const& x, R const& y) {
    ...
    return Mv1<R>((x[0] * y), (x[1] * y), (x[2] * y));
}

template <class R>
Mv2<R> operator*(Mv2<R> const& x, R const& y) {

    return Mv2<R>((x[0] * y), (x[1] * y), (x[2] * y));
}

template <class R>
Mv02<R> operator*(Mv02<R> const& x, R const& y) {

    return Mv02<R>((x * y), (x[1] * y), (x[2] * y), (x[3] * y));
}

template <class R>
Mv13<R> operator*(Mv13<R> const& x, R const& y) {

    return Mv13<R>((x[0] * y), (x[1] * y), (x[2] * y), (x[3] * y));
}

template <class R>
Mv3<R> operator*(Mv3<R> const& x, R const& y) {
